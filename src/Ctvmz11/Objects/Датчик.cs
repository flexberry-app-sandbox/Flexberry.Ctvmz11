...
namespace IIS.Ctvmz11
{
    ...
    public class Датчик : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Ctvmz11.Контроллер fКонтроллер;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Ctvmz11.Контроллер.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Контроллер"})]
        public virtual IIS.Ctvmz11.Контроллер Контроллер
        {
            get
            {
                ...
                IIS.Ctvmz11.Контроллер result = this.fКонтроллер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДатчикE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДатчикE", typeof(IIS.Ctvmz11.Датчик));
                }
            }
        }
    }
    ...
    public class DetailArrayOfДатчик : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Ctvmz11.DetailArrayOfДатчик members)

        // *** End programmer edit section *** (IIS.Ctvmz11.DetailArrayOfДатчик members)
        ...
        /// </summary>
        public DetailArrayOfДатчик(IIS.Ctvmz11.Контроллер fКонтроллер) : 
                base(typeof(Датчик), ((ICSSoft.STORMNET.DataObject)(fКонтроллер)))
        {
        }
        
        public IIS.Ctvmz11.Датчик this[int index]
        {
            get
            {
                return ((IIS.Ctvmz11.Датчик)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Ctvmz11.Датчик dataobject)
        {
